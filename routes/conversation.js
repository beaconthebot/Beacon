...
const input_wkspace=req.body.chat;


    const workspace = process.env.WORKSPACE_ID || input_wkspace;
    if (!workspace || workspace === input_wkspace) {
      return res.json({
        output: {
          text: b+'The app has not been configured with a <b>WORKSPACE_ID</b> environment variable. Please refer to the ' +
